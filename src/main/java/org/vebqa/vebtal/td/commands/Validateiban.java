...
@Keyword(module = TDTestAdaptionPlugin.ID, command = "validateIBAN", description = "validate an IBAN number", hintTarget = "<IBAN>")
public class Validateiban extends AbstractCommand {

	public Validateiban(String aCommand, String aTarget, String aValue) {
